...
class GuildInfo(val guild: Guild, serverAdminRoles: List<Role> = emptyList(), var initialRole: Role? = null, var rulesChannel: TextChannel? = null,
                ...
                var volume: Int = 50, volumeMultipliers: Map<String, Double> = emptyMap(), var funStuff: Boolean = false, var displayDeleted: Boolean = true, var displayModified: Boolean = true)
{
    ...
    val messageBuffer = RingBuffer<Message>(1 shl 10) // 1024
